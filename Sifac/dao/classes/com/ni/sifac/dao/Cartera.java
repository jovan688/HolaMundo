...
// KEEP INCLUDES END
/**
 * Entity mapped to table "CARTERA".
 */
public class Cartera {
    ...
    public Cartera(Long id, String Cedula, String Ciudad, Integer ClienteID, String Direccion, String FechaAbono, Float MontoCuota, String NombreCompleto, String OrdenCobro, String Pais, String RutaAsignada, Float Saldo, String SccCuentaID, Integer StbRutaID, Integer ojbCobradorID) {
        this.id = id;
        this.Cedula = Cedula;
        this.Ciudad = Ciudad;
